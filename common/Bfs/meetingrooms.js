...
function canAttendAllMeeting(schedulesArr){
    ...
    for(let i=0;i<schedulesArr.length;i++){
        ...
        if(schedulesArr[i][0]<lastMeetingTime)
        {
            return false
        }
        else {
            lastMeetingTime = schedulesArr[i][1]
        }
...
console.log(canAttendAllMeeting([[1, 4], [10, 15], [7, 10]]))
console.log(canAttendAllMeeting([[2, 4], [9, 12], [6, 10]]))
console.log(canAttendAllMeeting([[5, 10], [10, 20]]))
